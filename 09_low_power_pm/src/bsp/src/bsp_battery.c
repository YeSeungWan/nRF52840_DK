...
/**
 * @brief      Retrieves the internal static ADC spec reference for external Device PM tracking.
 * @param[in]  None
 * @return     const struct device* Pointer to the underlying ADC device instance.
 */
const struct device *bsp_battery_get_dev(void)
{
    return adc_channel.dev;
}
